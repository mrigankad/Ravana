...
class TestPoseMatch:
    def test_yaw_proxy_frontal_higher_than_profile(self):
        ...
        frontal = _Face(
            [0, 0, 100, 120], [[30, 40], [70, 40], [50, 60], [35, 80], [65, 80]]
        )
        profile = _Face(
            [0, 0, 100, 120], [[48, 40], [55, 40], [52, 60], [45, 80], [58, 80]]
        )
    ...
    def test_rank_sources(self):
        ...
        good = _Face(
            [0, 0, 100, 120], [[31, 40], [69, 40], [50, 60], [35, 80], [65, 80]]
        )
        bad = _Face(
            [0, 0, 100, 120], [[48, 40], [54, 40], [51, 60], [46, 80], [56, 80]]
        )
...
class TestTinyFaceUpscale:
    def test_no_boost_when_large(self):
        ...
        face = _Face(
            [20, 20, 140, 160], [[50, 60], [110, 60], [80, 90], [55, 120], [105, 120]]
        )
        out, faces, scale = upscale_frame_for_tiny_faces(
            img, [face], min_side_trigger=64
        )
        assert scale == 1.0
    ...
    def test_boosts_tiny_face(self):
        ...
        face = _Face(
            [100, 80, 140, 130],
            [[110, 95], [130, 95], [120, 105], [112, 118], [128, 118]],
        )
        out, faces, scale = upscale_frame_for_tiny_faces(
